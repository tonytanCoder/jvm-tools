...
public class MiddleIndex {
	...
	public static void main(String[] args) {
		BitSet2 bitSet2=new BitSet2();
		/*bitSet2.set(1,false);*/
		System.out.println(bitSet2.get(1));
	}
	
	public int findMiddleIndex(int[] nums) {
		BitSet2 bBitSet=new BitSet2();
		BitSet2 aBitSet=new BitSet2();
		for (int bIndex = 0, aIndex = nums.length-1; bIndex < aIndex;) {
			Boolean exist=bBitSet.get(bIndex);
			if(exist==true){
				bIndex++;
				continue;
			}
			int temp=nums[bIndex]-nums[aIndex];
			if(temp==0&&bIndex-aIndex==2){
				return bIndex+1;
			}
	...
	public static class BitSet2 implements Cloneable, java.io.Serializable {
	    /*
